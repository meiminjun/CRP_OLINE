 ...
 *
 */
Ext.define('CRP.ux.CustomLoading',{
        ...
        config:{
            ...
            tpl:[
                '<div class="x-easymimask-{type}"></div>',
                '<div>{message}</div>'
            ],
            modal:true
        },
        ...
        setPara:function(config){
            var me = this,
            	marginH = (window.innerHeight/2)-32;
            me.setData({
            ...
            me.setHideAnimation(Ext.os.is.Android ? null : {type: 'fadeOut', duration: 250, easing: 'ease-out'});
        },
        /**
         *  遮盖位置
         */
...
//          console.log(initconfig);
        ...
        Ext.onSetup(function(){
        	CRP.ux.CustomLoading = new EasymiMask;
        });
    }
);
