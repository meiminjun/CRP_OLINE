...
Ext.ClassManager.addNameAlternateMappings({
  "CRP.controller.Favorite": [],
  "CRP.controller.Main": [],
  "CRP.controller.NavController": [],
  "CRP.controller.NewsCtr": [],
  "CRP.controller.StockCtr": [],
  "CRP.model.MainListModel": [],
  "CRP.model.NewsModel": [],
  "CRP.model.OfflineLocalModel": [],
  "CRP.model.StockModel": [],
  "CRP.store.FavoriteStore": [],
  "CRP.store.MainListStore": [],
  "CRP.store.NewsStore": [],
  "CRP.store.OfflineLocalStore": [],
  "CRP.store.StockListStore": [],
  "CRP.util.PubOperation": [],
  "CRP.ux.CustomLoading": [],
  "CRP.ux.ImageViewer": [],
  "CRP.ux.Manager": [],
  "CRP.ux.PullRefreshFn": [],
  "CRP.ux.SelectFieldView": [],
  "CRP.ux.TimePicker": [
    "timePicker"
  ],
  "CRP.ux.Timefield": [
  ...
  "CRP.ux.override.Button": [],
  "CRP.ux.override.Component": [],
  "CRP.ux.override.Container": [],
  "CRP.ux.override.DataView": [],
  "CRP.ux.override.TitleBar": [],
  "CRP.ux.override.Toolbar": [],
  "CRP.ux.override.field.DatePicker": [],
  "CRP.ux.override.field.Field": [],
  "CRP.ux.override.form.FieldSet": [],
  "CRP.ux.override.navigation.Bar": [],
  "CRP.ux.override.navigation.View": [],
  "CRP.ux.override.picker.Date": [],
  "CRP.ux.override.picker.Picker": [],
  "CRP.ux.override.plugin.ListPaging": [],
  "CRP.ux.override.plugin.PullRefresh": [],
  "CRP.view.Favorite": [],
  "CRP.view.FavoriteList": [],
  "CRP.view.Main": [],
  "CRP.view.MainList": [],
  "CRP.view.News": [],
  "CRP.view.NewsList": [],
